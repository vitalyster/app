...
class AppDelegate: ExpoAppDelegate, ExpoReactNativeFactoryProvider {
  ...
  public override func application(
    ...
    // The window is created and React Native started by ExpoAppSceneDelegate (UIScene lifecycle, required by iOS 27)
  ...
  public override func application(
    ...
    if url.absoluteString.hasPrefix("tooot-share://") {
